...
public:
    ...
    complex_amplitude(const class gauss_beam& gauss_beam_, const class vortex& vortex_, const QSize& size);
    complex_amplitude(const class gauss_beam& gauss_beam, QImage& phase);
    complex_amplitude(const class gauss_beam& gauss_beam, const class vortex& vortex_, const QSize& size, const hole& hole);
    complex_amplitude(const class gauss_beam& gauss_beam_, QImage& phase, const hole& hole);
